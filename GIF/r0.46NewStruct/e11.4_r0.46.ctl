...
(set! geometry
      (append ; combine lists of objects:                                       
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 11) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 11) (radius r) (height infinity)
              (material air)))
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 12) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 12) (radius r) (height infinity)
              (material air)))
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 13) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 13) (radius r) (height infinity)
              (material air)))
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 14) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 14) (radius r) (height infinity)
              (material air)))
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 15) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 15) (radius r) (height infinity)
              (material air)))
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 8) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 8) (radius r) (height infinity)
              (material air)))
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 9) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 9) (radius r) (height infinity)
              (material air)))
       ...
       (geometric-object-duplicates (vector3 1 0) 0 (- N 1)
        (make cylinder (center (/ d 2) 10) (radius r) (height infinity)
              (material air)))
       (geometric-object-duplicates (vector3 -1 0) 0 (- N 1)
        (make cylinder (center (/ d -2) 10) (radius r) (height infinity)
              (material air)))
	...
	;three part: waveguid ->defect -> waveguide
       (list (make block (center -13 0) (size 13 ww infinity)
                   (material (make dielectric (epsilon eps)))))
       (list (make block (center 13 0) (size 13 ww infinity)
                   (material (make dielectric (epsilon eps)))))
       ;(list (make block (center 0 0) (size 2 2 infinity)
       ;            (material (make dielectric (epsilon 5)))))
	;(list (make cylinder (center (/ d -2) 0) (radius r) (height infinity)
...
(run-until 600
        ...
        (to-appended "hz" (at-every 5 output-hfield-z))
