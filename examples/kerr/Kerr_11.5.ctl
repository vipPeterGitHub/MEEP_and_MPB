...
(define-param w 1.28) ; width of waveguide                                       
...
(set! geometry
      (append ; combine lists of objects:                                       
       ...
       (list (make block (center 0 0) (size infinity 0.72 infinity)
                   (material (make dielectric (epsilon eps)))))

       (list (make block (center 0 2) (size 0.72 0.72 infinity)
                   (material (make dielectric (epsilon 11.5)))))
...
(define-param fcen 0.2388) ; pulse center frequency(pre_value)
...
(define f 0.23578024764025746)
(define Q 1773.2076574587547)
